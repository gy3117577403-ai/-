...
/**
 * A4 采购合同打印视图（甲方信息按企业模板固定，品名/数量/单价/总额为动态数据）
 */
export function ContractPrintView({ purchase }: Props) {
  ...
  return (
    <div
      ...
      className="contract-print-root mx-auto box-border min-h-[297mm] w-[210mm] bg-white p-10 text-black print:p-8"
    >
      <header className="border-b-2 border-black pb-3 text-center">
        <h1 className="text-xl font-bold tracking-wide">杭州杭连电子有限公司</h1>
      ...
      <h2 className="mt-6 text-center text-lg font-bold">物资采购合同（打印稿）</h2>
      ...
      <footer className="mt-10 flex justify-between text-sm print:mt-14">
        <div>
